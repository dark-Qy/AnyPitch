...
AnyPitch 是一个面向西土城FC的教练工作台。第一版脚手架覆盖教练登录、队员免密入口、队员管理、训练/友谊赛日程、日程内出勤登记、地点管理，以及支持我方/对手站位的 5/8/11 人制战术板保存。
...
- 队员只能查看日程、查看参加/拒绝/待定/未确认汇总，并维护自己的参加状态；队员端会展示自己对全部日程的总状况，已结束日程单独分块，不能管理队员、地点、战术板或全队出勤
