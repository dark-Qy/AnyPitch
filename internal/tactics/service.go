	...
	return []Template{
		{
			...
			Formation: "1-2-1",
			Slots: []Slot{
				{SlotID: "gk", Label: "GK", X: 50, Y: 91},
				{SlotID: "ld", Label: "LD", X: 28, Y: 65},
				{SlotID: "rd", Label: "RD", X: 72, Y: 65},
				{SlotID: "am", Label: "AM", X: 50, Y: 41},
				{SlotID: "fw", Label: "FW", X: 50, Y: 18},
			},
		},
		{
			Format:    8,
			...
			Formation: "2-3-2",
			Slots: []Slot{
				{SlotID: "gk", Label: "GK", X: 50, Y: 93},
				{SlotID: "lb", Label: "LB", X: 32, Y: 73},
				{SlotID: "rb", Label: "RB", X: 68, Y: 73},
				{SlotID: "lm", Label: "LM", X: 25, Y: 49},
				{SlotID: "cm", Label: "CM", X: 50, Y: 50},
				{SlotID: "rm", Label: "RM", X: 75, Y: 49},
				{SlotID: "lf", Label: "LF", X: 38, Y: 22},
				{SlotID: "rf", Label: "RF", X: 62, Y: 22},
			},
		},
		{
			Format:    11,
			...
			Formation: "4-3-3",
			Slots: []Slot{
				{SlotID: "gk", Label: "GK", X: 50, Y: 95},
				{SlotID: "lb", Label: "LB", X: 18, Y: 76},
				{SlotID: "lcb", Label: "LCB", X: 39, Y: 78},
				{SlotID: "rcb", Label: "RCB", X: 61, Y: 78},
				{SlotID: "rb", Label: "RB", X: 82, Y: 76},
				{SlotID: "dm", Label: "DM", X: 50, Y: 57},
				{SlotID: "lcm", Label: "LCM", X: 34, Y: 46},
				{SlotID: "rcm", Label: "RCM", X: 66, Y: 46},
				{SlotID: "lw", Label: "LW", X: 22, Y: 22},
				{SlotID: "st", Label: "ST", X: 50, Y: 16},
				{SlotID: "rw", Label: "RW", X: 78, Y: 22},
			},
		},
	}
}
